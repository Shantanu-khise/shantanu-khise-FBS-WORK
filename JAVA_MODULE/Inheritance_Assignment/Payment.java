...
class RegisterPayment {
	public static void main(String[] args) {
		CreditCardPayment c1 = new CreditCardPayment(101, 2500.75, "12-11-2025", "Shantanu", 987654321, 123, "Visa");
		c1.display();
		System.out.println("\n\n");
		UPIPayment u1 = new UPIPayment(102, 1500.50, "12-11-2025", "Shantanu", 987654, "Google Pay", 123456789);
		u1.display();
		System.out.println("\n\n");
		CashPayment cs1 = new CashPayment(103, 2000.00, "12-11-2025", "Shantanu	 ", 501, "Ramesh", "INR");
		cs1.display();
