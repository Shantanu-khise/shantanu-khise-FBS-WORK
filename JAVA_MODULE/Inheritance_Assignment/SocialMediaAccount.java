...
public class SocialMediaAccount {
	...
	public SocialMediaAccount(String userName, String email, boolean isPublic, boolean isVerified, String countryOrigin,
			int noOfPost, int likes, int comments, String createdAt) {
...
class InstagramAccount extends SocialMediaAccount {
	...
	public InstagramAccount(String userName, String email, boolean isPublic, boolean isVerified, String countryOrigin,
			int noOfPost, int likes, int comments, String createdAt, int noOfFollowers, int noOfFollowing,
			int noOfHighlights, int noOfPostArchieve, int noOfStoryArchieve, int noOfAudioSave) {
...
class LinkdenAccount extends SocialMediaAccount {
	...
	public LinkdenAccount(String userName, String email, boolean isPublic, boolean isVerified, String countryOrigin,
			int noOfPost, int likes, int comments, String createdAt, int noOfConnections, int noOfProfileView,
			int noOfJobsApplied) {
		super(userName, email, isPublic, isVerified, countryOrigin, noOfPost, likes, comments, createdAt);
...
class YoutubeAccount extends SocialMediaAccount {
	...
	public YoutubeAccount(String userName, String email, boolean isPublic, boolean isVerified, String countryOrigin,
			int noOfPost, int likes, int comments, String createdAt, int noOfSubscribers, int watchTime,
			boolean isMonetize, double estimatedRevenue) {
		super(userName, email, isPublic, isVerified, countryOrigin, noOfPost, likes, comments, createdAt);
...
class RegisterAccount {
	public static void main(String[] args) {
		InstagramAccount insta = new InstagramAccount("Shantanu", "Shantanu@email.com", true, false, "India", 25, 455,
				54, "24-10-2025", 100, 150, 10, 5, 20, 7);
		insta.display();
		System.out.println("\n\n");
		LinkdenAccount link = new LinkdenAccount("Shantanu", "Shantanu@gmail.com", true, true, "India", 20, 150, 30,
				"24-10-2025", 500, 200, 25);
		link.display();
		System.out.println("\n\n");
		YoutubeAccount yt = new YoutubeAccount("Shantanu", "Shantanu@gmail.com", true, true, "India", 40, 2500, 300,
				"24-10-2025", 50000, 12000, true, 1500.75);
		yt.display();
